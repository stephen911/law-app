      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        ...
        Column(
          ...
          children: [
            ...
            Container(
                child: Text(this.rating, style: TextStyle(color: Colors.grey))),
          ],
        ),
        Container(
          height: 5,
        ...
        Column(
          ...
          children: [
            ...
            Container(
                child: Text(this.firm, style: TextStyle(color: Colors.grey))),
            Container(
                child:
                    Text(this.location, style: TextStyle(color: Colors.grey))),
            SizedBox(
              height: 10,
            ),
          ],
